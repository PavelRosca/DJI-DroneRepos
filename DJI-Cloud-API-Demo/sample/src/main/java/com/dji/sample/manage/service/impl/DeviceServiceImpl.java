    ...
    public TopologyDeviceDTO deviceConvertToTopologyDTO(DeviceDTO device) {
        ...
        return new TopologyDeviceDTO()
                    ...
                    .setDeviceModel(new TopologyDeviceModel()
                            ...
                            .setDeviceModelKey(DeviceEnum.findOrNull(
                                device.getDomain() != null ? device.getDomain().getDomain() : -1,
                                device.getType() != null ? device.getType().getType() : -1,
                                device.getSubType() != null ? device.getSubType().getSubType() : 0)))
